    ...
    Carnes: [
        {
            ...
            descripcion: ["Chorizo colorado de ternera.", "El peso puede variar ligeramente."],
            precio: 5000,
        ...
        {
            nombre: "Lomo x KG",
            descripcion: ["Lomo de ternera.", "El peso puede variar ligeramente."],
            precio: 8500,
        ...
        },
        {
            ...
            descripcion: ["Milanesas de carne de pechuga de pollo.", "El peso puede variar ligeramente."],
            precio: 6000,
        ...
        },
        {
            ...
            descripcion: ["Carne picada con alto contenido de grasa.", "El peso puede variar ligeramente."],
            precio: 4000,
